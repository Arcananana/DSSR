...
def generate_mod_LR_bic():
    ...
    mod_scale = 3
    # set data dir
    sourcedir = "/opt/data/private/wyx/dataset/Set14/source/"
    savedir = "/opt/data/private/wyx/dataset/Set14/"
    ...
    for i in range(num_files):
     ...
     #       image_Bic = imresize(image_LR_blur, up_scale, True)
     #       cv2.imwrite(os.path.join(saveBicpath, 'sig{}_{}'.format(sig,filename)), image_Bic)
        # LR
